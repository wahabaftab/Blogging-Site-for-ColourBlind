...
<body style=" background-image: url('images/fashion-back.jpg')"" class="imagess"  class="body-color">
...
<div class="col-sm-7">
      ...
      <div class="row" style="width:755px;margin-left: 0px">
        <div class="col-sm-12">
          <div style="color:#000!important;background-color:#fff!important;border-radius:4px!important" class="boxes">
            <div class="containers write-box-padding">
            <h3>Fashion Blogs</h3>
              <p class=" write-box-padding">Find Everything about fashion here!!! </p>
      ...
      <?php 
       include_once("./database/connectDB.php");
     	$query2 = "SELECT * FROM blog where catagory= 'Fashion'";
