...
<?php
	...
	$tempid=$_SESSION['ID'];
	$query="SELECT * from users WHERE ID= ".$tempid;
        ...
        <div class="col-sm-12">
          <div style="background-color:#E8E8E8 	;border-radius:4px!important; " class="boxes">
            <div class="containers write-box-padding">
                                    <button class="buttons " id="search" type="submit"> Search  <i class="fa fa-search"> </i>
 </button>
<br><br>

  <input type="text" name="search" id="frmsearch">
            </div>
          </div>
        </div>
      </div>
   ...
   <div >
    ...
    <hr style="color:#4d636f">

    <a href="buissness.php"><p>-Buissness</p></a>
    <a href="entertainment.php"><p>-Entertainment</p></a>
    <a href="fashion.php"><p>-Fashion</p></a>
    <a href="sports.php"><p>-Sports</p></a>
    <a href="literature.php"><p>-Literature</p></a>
    <a href="medical.php"><p>-Medical</p></a>
    <a href="nature.php"><p>-Nature</p></a><hr>
