...
<body style=" background-image: url('images/entertainment-back.jpg')"" class="imagess"  class="body-color">
...
<div class="col-sm-7">
        ...
        <div class="col-sm-12">
          <div style="color:#000!important;background-color:#fff!important;border-radius:4px!important" class="boxes">
            ...
            <h3>Entertainment Blogs</h3>
              <p class=" write-box-padding">Find Everything about entertainment here!!! </p>
      ...
      <?php 
       include_once("./database/connectDB.php");
     	$query2 = "SELECT * FROM blog where catagory= 'Entertainment'";
